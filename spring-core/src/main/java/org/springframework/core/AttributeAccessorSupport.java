...
public abstract class AttributeAccessorSupport implements AttributeAccessor, Serializable {
	...
	/**
	 * 可以存beanDefinition元数据信息
	 * 因为GenericBeanDefinition也是描述beanDefinition元数据的类
	 * 但是他里面的属性固定的 比如lazy、scope之类的，但是beanDefinition可能有很多描述信息
	 * (比如一个类上面加了很多注解但是不在GenericBeanDefinition属性描述范围之内)
	 * 那么就可以用这个属性类描述
	 */
